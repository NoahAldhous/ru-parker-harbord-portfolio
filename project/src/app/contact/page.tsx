...
export default function Page(){
    ...
    return <main className="h-screen w-screen flex flex-row justify-center items-center pt-navbar-height px-page-horizontal-padding">
        <section className="w-11/12 h-5/6 flex flex-row justify-between">
            <section className="h-full w-2/5 flex justify-center items-start">
                <Image
                    src={portrait}
                    alt="ru portrait"
            ...
            <div className="w-full h-1/5 text-md flex flex-col justify-evenly">
                <p>If you are enquiring about wedding bookings please use the contact form on my wedding page found here</p>
                <br/>
                <p>Otherwise please drop me a line using the link above!</p>
            </div>
            </section>
        </section>
    </main>
